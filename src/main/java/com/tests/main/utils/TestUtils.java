...
import com.tests.main.tests.glossary.tests.glossary.GlossaryOld;
...
public class TestUtils {
    ...
    public static EntityMutationResponse deleteEntities(List<String> guids) throws AtlasServiceException {
        return atlasClient.deleteEntitiesByGuids(guids);
    }

    public static EntityMutationResponse deleteEntityHard(String guid) throws AtlasServiceException {
        return atlasClient.deleteEntityByGuidHard(guid);
    }
    ...
    public static String createClassification(String name) throws AtlasServiceException {
        ...
        return atlasClient.createAtlasTypeDefs(typesDef).getClassificationDefs().get(0).getName();
    }
